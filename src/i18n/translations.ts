...
const en = {
  ...
  settings: {
    ...
    exportSub:        'share a JSON file with all your data',
    importBtn:        'import backup',
    importSub:        'restore from a previous backup',
    exportingMsg:     'Preparing backup...',
    importPickTitle:  'Pick a Veil backup file',
    importPreviewTitle: (date: string, ci: number, ve: number) =>
      `Backup from ${date}\n${ci} check-ins · ${ve} voice entries`,
    importModeReplace: 'Replace all',
    importModeMerge:   'Merge',
    importModeCancel:  'Cancel',
    importSettingsTitle: 'Apply settings from backup?',
    importSettingsMsg:   'Theme and language preferences will be overwritten.',
    importFTTitle:    'Apply personalisation from backup?',
    importFTMsg:      'The ML model weights from the backup will replace your current personalisation.',
    importYes:        'Yes',
    importNo:         'Skip',
    importSuccess:    (ci: number, ve: number) => `Imported ${ci} check-ins and ${ve} voice entries.`,
    importSuccessTitle: 'Import complete',
    exportError:      'Export failed',
    importError:      'Import failed',
    importInvalidFile: 'This file is not a valid Veil backup.',
  },
} as const;
...
const ru = {
  ...
  settings: {
    ...
    exportSub:        'поделиться JSON-файлом со всеми данными',
    importBtn:        'импорт данных',
    importSub:        'восстановить из резервной копии',
    exportingMsg:     'Подготовка резервной копии...',
    importPickTitle:  'Выбери файл резервной копии Veil',
    importPreviewTitle: (date: string, ci: number, ve: number) =>
      `Резервная копия от ${date}\n${ci} ${pluralRu(ci, 'чекин', 'чекина', 'чекинов')} · ${ve} ${pluralRu(ve, 'запись', 'записи', 'записей')}`,
    importModeReplace: 'Заменить всё',
    importModeMerge:   'Объединить',
    importModeCancel:  'Отмена',
    importSettingsTitle: 'Применить настройки из резервной копии?',
    importSettingsMsg:   'Настройки темы и языка будут перезаписаны.',
    importFTTitle:    'Применить персонализацию из резервной копии?',
    importFTMsg:      'Веса ML-модели из резервной копии заменят текущую персонализацию.',
    importYes:        'Да',
    importNo:         'Пропустить',
    importSuccess:    (ci: number, ve: number) => `Импортировано ${ci} ${pluralRu(ci, 'чекин', 'чекина', 'чекинов')} и ${ve} ${pluralRu(ve, 'запись', 'записи', 'записей')}.`,
    importSuccessTitle: 'Импорт завершён',
    exportError:      'Ошибка экспорта',
    importError:      'Ошибка импорта',
    importInvalidFile: 'Этот файл не является допустимой резервной копией Veil.',
  },
} as const;
